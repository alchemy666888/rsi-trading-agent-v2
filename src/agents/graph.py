...
from agents.nodes import data_node, decision_node, evaluate_node, optimize_node, predict_node, risk_node, runtime_config_node
...
def build_agent_graph():
    ...
    workflow.add_node("runtime", runtime_config_node)
    ...
    workflow.add_edge("data", "runtime")
    workflow.add_edge("runtime", "predict")
